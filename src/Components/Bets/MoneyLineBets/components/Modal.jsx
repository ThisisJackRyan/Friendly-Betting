...
const Modal = ({handleModal, contestant1, contestant2}) => {

    return (
        <div className='absolute bottom-0 inset-x-0 w-full md:max-w-screen-md md:m-auto'>
            <CloseX action={handleModal} divStyle="flex justify-end" IconStyle="text-3xl mr-1 mb-1 cursor-pointer rounded-full black-border" backgroundColor='#ddece0'/>
